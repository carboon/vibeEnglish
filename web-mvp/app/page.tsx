          ...
          <div className="space-y-6">
            <div className="border-2 border-dashed rounded-xl p-8 text-center transition-colors">
              <input
                ...
                disabled={processingProgress.status !== 'idle' && processingProgress.status !== 'complete'}
                className="hidden"
              />
              <label
                htmlFor="video"
                className={`cursor-pointer block ${(processingProgress.status !== 'idle' && processingProgress.status !== 'complete') ? 'opacity-50 pointer-events-none' : ''}`}
              >
            ...
            <div className="flex gap-4">
              <button
                ...
                disabled={!videoFile || (processingProgress.status !== 'idle' && processingProgress.status !== 'complete')}
